...
#### Global tag
global_tag = '106X_dataRun2_v32' # 2017, 2018
...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('/store/data/Run2017B/Charmonium/AOD/09Aug2019_UL2017-v1/20000/02402510-96BA-034C-B3AB-32F226318344.root'
#MuOnia UL 2017E AOD
...
process.nano = cms.EDAnalyzer('NanoAnalyzer',
                              ...
                              outFile = cms.string('test_vertex.root'),
                              #writeCovariance = cms.bool(True),
                              # Change this:
                              # If MC:
