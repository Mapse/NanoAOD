...
config.JobType.psetName = 'nanoanalyzer_jpsi_gun.py'
...
config.Data.outputPrimaryDataset = 'CRAB_PrivateMC_RunII_UL_2018'

config.JobType.outputFiles = ['Jpsi_gun_NanoAODplus.root'] 
