...
# 2017 UL JSON
#goodJSON = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions17/13TeV/Legacy_2017/Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt'
# 2018 UL JSON
#goodJSON = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions18/13TeV/Legacy_2018/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt'
...
#files = FileUtils.loadListFromFile("UpsilonToMuMuDstarToD0pi.txt")

# To submit batch job using CRAB or test locally (2nd option), use this:
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring('file:AOD_9.root'),
#MuOnia UL 2017E AOD
...
# MC AODSIM
#          'file://UpsilonToMuMuDzero_13TeV_AODSIM.root',)
# MC MiniAOD
#           'file://UpsilonToMuMuDzero_13TeV_MiniAOD.root',)
# Chamonium UL AOD
...
process.nano = cms.EDAnalyzer('NanoAnalyzer',
                              ...
                              # If CRAB:
                              outFile = cms.string('JpsiPtGun.root'),
