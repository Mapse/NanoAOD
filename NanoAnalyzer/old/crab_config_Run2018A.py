...
### ---------------------  AOD Primary Dataset --------------------- ###
config.General.requestName = 'CharmoniumRun2018A_AOD'
config.JobType.psetName = 'nanoanalyzer_Run2018A.py'
config.Data.inputDataset = '/Charmonium/Run2018A-12Nov2019_UL2018_rsb-v1/AOD'
config.Data.outputDatasetTag = 'CharmoniumRun2018A_AOD'
config.JobType.outputFiles = ['CharmoniumRun2018A_AOD.root']
