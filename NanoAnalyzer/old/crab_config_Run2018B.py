...
### ---------------------  AOD Primary Dataset --------------------- ###
config.General.requestName = 'CharmoniumRun2018B_AOD'
config.JobType.psetName = 'nanoanalyzer_Run2018B.py'
config.Data.inputDataset = '/Charmonium/Run2018B-12Nov2019_UL2018-v1/AOD'
config.Data.outputDatasetTag = 'CharmoniumRun2018B_AOD'
config.JobType.outputFiles = ['CharmoniumRun2018B_AOD.root']
