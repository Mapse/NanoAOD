...
### ---------------------  AOD Primary Dataset --------------------- ###
config.General.requestName = 'CharmoniumRun2017D_AOD'
config.JobType.psetName = 'nanoanalyzer_Run2017D.py'
config.Data.inputDataset = '/Charmonium/Run2017D-09Aug2019_UL2017-v1/AOD'
config.Data.outputDatasetTag = 'CharmoniumRun2017D_AOD'
config.JobType.outputFiles = ['CharmoniumRun2017D_AOD.root']
