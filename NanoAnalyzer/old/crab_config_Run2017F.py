...
### ---------------------  AOD Primary Dataset --------------------- ###
config.General.requestName = 'CharmoniumRun2017F_AOD'
config.JobType.psetName = 'nanoanalyzer_Run2017F.py'
config.Data.inputDataset = '/Charmonium/Run2017F-09Aug2019_UL2017-v1/AOD'
config.Data.outputDatasetTag = 'CharmoniumRun2017F_AOD'
config.JobType.outputFiles = ['CharmoniumRun2017F_AOD.root']
