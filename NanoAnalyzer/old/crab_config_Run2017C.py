...
### ---------------------  AOD Primary Dataset --------------------- ###
config.General.requestName = 'CharmoniumRun2017C_AOD'
config.JobType.psetName = 'nanoanalyzer_Run2017C.py'
config.Data.inputDataset = '/Charmonium/Run2017C-09Aug2019_UL2017-v1/AOD'
config.Data.outputDatasetTag = 'CharmoniumRun2017C_AOD'
config.JobType.outputFiles = ['CharmoniumRun2017C_AOD.root']
