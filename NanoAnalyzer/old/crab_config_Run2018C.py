...
### ---------------------  AOD Primary Dataset --------------------- ###
config.General.requestName = 'CharmoniumRun2018C_AOD'
config.JobType.psetName = 'nanoanalyzer_Run2018C.py'
config.Data.inputDataset = '/Charmonium/Run2018C-12Nov2019_UL2018_rsb_v2-v2/AOD'
config.Data.outputDatasetTag = 'CharmoniumRun2018C_AOD'
config.JobType.outputFiles = ['CharmoniumRun2018C_AOD.root']
